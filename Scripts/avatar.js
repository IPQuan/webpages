  ...
  CropAvatar.prototype = {
    ...
    startCropper: function () {
      ...
      if (this.active) {
        ...
        this.$img.cropper({
          aspectRatio: 1,
          preview: "body #avatar-modal .avatar-preview",//this.$avatarPreview.selector,
          strict: false,
          crop: function (data) {
            var json = [
              '{"x":' + data.x,
    ...
    ajaxUpload: function () {
      var url = this.$avatarForm.attr('action'),
          ...
          _this = this;
      // url action 后台调整
      //参考网址:http://blog.csdn.net/mfc2003/article/details/49835705 步骤
      //参考网址:http://blog.csdn.net/houxuehan/article/details/52025404
      //我有后台PHP源码,如果有需要可以告知.
      alert('提交,后台裁切');
